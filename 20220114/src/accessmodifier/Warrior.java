...
public class Warrior {// 정의부, 실행은 .Main에서 할 예정임
	...
	// 외부에서 값을 함두로 고칠 수 없도록 public 대신 private으로 고칩니다
	// public :모든 영역에서 수정 조회/ 가능 private : 자기 자신만 수정 /조회 불가능
    // protected : 같은 패키지 / 자기자신만 수정/조회 가능
	...
	// 생성자를 만들어 주되, name만 사용자에게 입력받고
	// 나머지는 hp 20, str 3 , lv 1; money 0 을 
	// 자동으로 입력받도록 해 주세요.
	...
	public Warrior(String n) {
     	...
     	// 체력이 2깍이고 돈을 10 획득합니다
     	// 사냥결과 체력이 ?가 되었고 소지금은 ?입니다 라고 출력합니다.
