...
public class Array01P146 {
	...
	public static void main(String[] args) {
		...
		// 배열은 크기를 정해서 생성할 수도 있고, 정하기 않고 생성할수도 있는데
		// 설정된 크기 이상으로 자료를 넣을 수 없습니다
		// 배열의 크기(저장가능개스)는 "배열의 길이"라고 표한합니다..
		// 배열명 .length를 이용해 배열크기를 알수있습니다.

		
		// 배열의 선언1(길이 확정x)
        double b = 5.3;
		System.out.println(b);
		int a[] = {1, 2, 3, 4}; // a변수에 1, 2, 3, 4를 동시에 넢기
		//Array.toString()이 없으면 콘솔창에 주소만 나옵니다
